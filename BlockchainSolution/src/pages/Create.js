...
class Create extends Component {
  ...
  handleGeoSelect1 = (address1) => {
    this.setState({address1, buttonDisabled: true})

    geocodeByAddress(this.state.address1)
      .then(results => getLatLng(results[0]))
      .then(latLng => {
        this.setState({latitude1: latLng.lat, longitude1: latLng.lng, buttonDisabled: false})
      })
      .catch(error => console.error('Error', error))
  }
            ...
            <div>
              ...
              <FormGroup>
                  ...
                  <PlacesAutocomplete
                    ...
                    onSelect={this.handleGeoSelect1}
                    classNames={{input: "form-control"}}
                  />
              </FormGroup>
              <FormGroup>
